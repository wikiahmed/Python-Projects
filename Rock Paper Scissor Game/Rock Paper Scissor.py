...
#Create a LabelFrame
labelframe= LabelFrame(win, text= "Rock Paper Scissor", font= ('Century 20 bold'),labelanchor= "n",bd=5,bg= "Deepskyblue",width= 600, height= 450, cursor= "target")
...
#Label for VS
l2= Label(labelframe, text="VS", font= ('Helvetica 18 bold'), bg="Deepskyblue")
...
label= Label(labelframe, text="", font=('Coveat', 25,'bold'), bg= "Deepskyblue")
label.pack(pady=150)
...
reset= Button(labelframe, text= "Reset",bg= "mediumvioletred", fg= "white",width= 7, font= 10, command= reset)
